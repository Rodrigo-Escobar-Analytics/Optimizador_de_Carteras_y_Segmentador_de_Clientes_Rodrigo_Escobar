...
scripts <- c(
  "07b.Segmentacion Aplicación Mensual.R",
  "08b.Alerta Temprana Red Neuronal Patrimonial - Mensual.R",
  "08b.Alerta Temprana Red Neuronal Tensos y Criticos - Mensual.R",
  "08b.Concatenador Alerta Temprana por Red Neuronal - Mensual.R",
