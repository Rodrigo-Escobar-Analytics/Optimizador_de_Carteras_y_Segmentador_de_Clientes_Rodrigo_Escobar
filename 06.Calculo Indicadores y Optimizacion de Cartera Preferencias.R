...
# TIEMPO ESTIMADO DE EJECUCION: 1 HORA - 1 HORA 30 MINUTOS
...
TBL_DATA_SHARES_ACCOUNTS_FINAL<-read_csv2("FILES/OUTPUT/05_PESOS_INDICADORES_CARTERA.CSV")
...
TBL_DATA_SHARES_ACCOUNTS_FINAL <- TBL_DATA_SHARES_ACCOUNTS_FINAL %>%
  ...
  mutate(
    TIPO_ACCION_CARTERA = ifelse(CANTIDAD_EN_CUSTODIA == 0, "PREFERENCIA AGREGADA", "ORIGINAL")
  )
